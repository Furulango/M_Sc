...
int sFlg = 0;
int monitorMode = 0;     // 0=telemetría completa, 1=solo lazos, 2=solo posición, 3=solo velocidad, 4=JSON
...
void sendTelemetry(void){
    ...
    switch(monitorMode){
        ...
        case 4: // JSON para app
            uart_print("{\"t\":");
            itoa10(smp, num); uart_print(num);
            uart_print(",\"line\":");
            ...
            uart_print(",\"va\":");
            itoa10(Va, num); uart_print(num);
            uart_print(",\"vd_ref\":");
            itoa10(Vdr, num); uart_print(num);
            uart_print(",\"vd_act\":");
            itoa10(velD, num); uart_print(num);
            uart_print(",\"vd_err\":");
            itoa10(errorD, num); uart_print(num);
            uart_print(",\"vd_out\":");
            itoa10(uD, num); uart_print(num);
            uart_print(",\"vi_ref\":");
            itoa10(Vir, num); uart_print(num);
            uart_print(",\"vi_act\":");
            itoa10(velI, num); uart_print(num);
            uart_print(",\"vi_err\":");
            itoa10(errorI, num); uart_print(num);
            uart_print(",\"vi_out\":");
            itoa10(uI, num); uart_print(num);
            uart_println("}");
            break;
