                    ...
                    if scenario['phase'] == 1:
                        ...
                        if alg_name == 'BFO':
                            algorithm = AlgorithmClass(objective, bounds, 
                                                     ...
                                                     n_bacteria=50,        # INCREASED for fair comparison
                                                     n_chemotactic=80,     # INCREASED for fair comparison
                                                     n_reproductive=4,     # INCREASED for fair comparison
                                                     n_elimination=3,      # Standard
                                                     is_adaptation=False)
                        else:
                            algorithm = AlgorithmClass(objective, bounds,
                                                     base_params=self.ideal_params,
                        ...
                        if alg_name == 'BFO':
                            algorithm = AlgorithmClass(objective, bounds, 
                                                     ...
                                                     n_reproductive=2,     # Reduced for adaptation
                                                     n_elimination=2,      # Reduced for adaptation
                                                     is_adaptation=True)
                        else:
                            algorithm = AlgorithmClass(objective, bounds,
                                                     base_params=base,  # Use BEST calibrated base
