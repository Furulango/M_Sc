...
from datetime import datetime # Necesario para nombrar los archivos de resultados
...
def plot_results(portfolio_values, benchmark_values, weights_history, dates, symbols):
    ...
    ax2.set_title('Retornos Acumulados', fontsize=14)
...
def main():
    ...
    # --- INICIO DE MODIFICACION: CREAR DIRECTORIO DE RESULTADOS ---
    ...
    try:
        ...
        results = backtest_strategy(data, lookback_days=252, rebalance_days=30, initial_capital=initial_capital)
        ...
        # --- INICIO DE MODIFICACION: PREPARAR Y GUARDAR REPORTE DE METRICAS ---
        report_lines = []
        ...
        # --- INICIO DE MODIFICACION: GUARDAR GRAFICO Y MOSTRAR ---
        ...
        plt.show() # Muestra el gráfico en pantalla como antes
        # --- FIN DE MODIFICACION ---
